...
import { ExampleUI, Hints, SigninPassport, IssueStamp, ConfigurePassportScoring } from "./views";
...
function App(props) {
  ...
  */
  ...
  return (
    <Provider client={{ ceramic: "mainnet-gateway" }} session={true}>
      <PassportProvider>
        <div className="App">
            ...
            <Menu.Item key="/stamp">
              ...
              <Switch>
                ...
                <Route exact path="/stamp">
                  <IssueStamp address={address} provider={userProvider} />
                </Route>
